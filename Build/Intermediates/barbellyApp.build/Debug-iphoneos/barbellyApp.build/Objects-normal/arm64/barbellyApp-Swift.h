...
SWIFT_CLASS("_TtC11barbellyApp26LoginConfirmViewController")
@interface LoginConfirmViewController : ViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified registerButton;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified weightTextField;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified heightTextField;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified userImage;
...
@property (nonatomic, strong) NSDictionary * _Nullable userProfile;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidLoad;
- (void)returnUserData;
- (UIImage * _Nonnull)trimPicture:(UIImage * _Nonnull)rawPic;
