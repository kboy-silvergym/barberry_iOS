//
//  EditHeightWeightDataSource.swift
//  barbellyApp
//
//  Created by 藤川慶 on 2016/05/25.
//  Copyright © 2016年 藤川慶. All rights reserved.
//

import UIKit

class EditPickerDataSource: NSObject, UIPickerViewDelegate, UIPickerViewDataSource  {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int){
        ...
        delegate?.heightWeightTextField.text = height! + "cm" + "/" + weight! + "kg"
